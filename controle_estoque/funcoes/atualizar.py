...
def atualizar_produtos(): # Criação de uma função para atualizar produtos
    ...
    try:
        ...
        if produto: 
            ...
            id, nome, marca, quantidade, preco = produto

            print(f"\nProduto atual: {nome}, Marca: {marca}, Quantidade: {quantidade}, Preço: R$ {preco:.2f}") # Mostrando ao usuário o produto desempacotado que será atualizado...
            ...
            nova_marca = input(f"Nova marca [{marca}]: ").strip() or marca # Nova marca, se nada for informado, a antiga marca continua
            ...
            cursor.execute("""
                ...
                WHERE id = ?
            """, (novo_nome, nova_marca, nova_quantidade, novo_preco, id_produto)) # Atualizando o nome, marca, quantidade, preco, do produto onde seu id é x
...
def atualizar_produtos_gui(janela_principal):# Criação de uma nova função que será chamada quando o usuário clicar no botão Atualizar Produto
    ...
    def atualizar():
        try:
            ...
            _, nome_atual, marca_atual, quantidade_atual, preco_atual = produto_atual
            ...
            linhas_afetadas = atualizar_produto_id(id_produto, nome, marca, quantidade, preco)
