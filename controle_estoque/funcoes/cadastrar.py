...
def cadastrar_produtos(): # Criação de uma função para o cadastro de produtos
...
def cadastrar_produtos_gui(janela_principal): # Criação de uma nova função que será chamada quando o usuário clicar no botão Cadastrar Produto
    ...
    janela_cadastro.geometry("300x300") # Define o tamanho da janela filha 300x300
    ...
    def salvar(): # Criação da função interna que salva os dados no banco
        ...
        sucesso, mensagem = cadastro_dos_produtos(nome, marca, quantidade, preco)
        if sucesso:
